...
class MailHandler extends AppConfig
{
    ...
    public function sendMail($userarr, $type)
    {
        ...
        if ($type == 'Verify') {
            ...
            include $this->base_dir."/login/partials/mailtemplates/solvedemail.php";

            //Set the subject line
            $mail->Subject = $this->site_name . ' Problema Resuelto!';

            //Set the body of the message
            $mail->Body = $solved_template;

            $mail->AltBody  =  'Tiene un problema nuevo resuelto y puede proceder a consultar los resultados.';
        };
