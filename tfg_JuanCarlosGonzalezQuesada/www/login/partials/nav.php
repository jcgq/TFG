    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="userDropdown">
                ...
                <li><a href="<?php echo $this->base_url; ?>/user/accountedit.php">Configuración de la cuenta</a></li>
                <li role="separator" class="divider"></li>

                <!-- Superadmin Controls -->
                <?php if ($auth->isSuperAdmin()): ?>
                  <li><a href="<?php echo $this->base_url; ?>/admin/config.php">Editar la configuración del sitio</a></li>
                ...
                <li><a href="<?php echo $this->base_url; ?>/login/logout.php">Cerrar sesión</a></li>
            </ul>
        </li>
    </ul>
