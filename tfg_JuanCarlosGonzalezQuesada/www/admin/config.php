...
**/
$userrole = 'Superadmin';
$title = 'Editar la configuración del sitio';
...
<div class="row">
<div class="col-sm-12">
<h3>Editar la configuración del sitio</h3>
...
<button class='btn btn-info' id='testemail'>Prueba de configuración del correo electrónico</button>
